...
if (addLocationBtn) {
  addLocationBtn.addEventListener("click", function () {
    ...
    newLocationFields.innerHTML = "\n      <label class=\"form__label\">Tour Coordinates</label>\n      <input class=\"form__input\" type=\"text\" placeholder=\"Coordinates\" id=\"coordinates-".concat(locationIndex, "\" required>\n      <label class=\"form__label\">Location Description</label>\n      <input class=\"form__input\" type=\"text\" placeholder=\"Description\" id=\"description-").concat(locationIndex, "\" required>\n      <label class=\"form__label\">Location Day</label>\n      <input class=\"form__input\" type=\"number\" placeholder=\"Day\" id=\"day-").concat(locationIndex, "\" required>\n    ");
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            e.preventDefault();
            locations = [];
            startDates = []; // Gather location data
            for (i = 0; i < locationIndex; i++) {
              coordinates = document.getElementById("coordinates-".concat(i)).value.split(",").map(function (coord) {
                return parseFloat(coord.trim());
              });
              description = document.getElementById("description-".concat(i)).value;
              day = document.getElementById("day-".concat(i)).value;
              if (coordinates && description && day) {
                locations.push({
                  type: "Point",
                  // Ensuring proper geospatial format
            ...
            // Gather start dates
            for (_i = 0; _i < dateIndex; _i++) {
              date = document.getElementById("dates-".concat(_i)).value;
              if (date) {
            ...
            formData.append("difficulty", document.getElementById("tour-difficulty").value.toLowerCase());
            formData.append("price", parseFloat(document.getElementById("tour-price").value));
            formData.append("duration", parseInt(document.getElementById("tour-duration").value));
            formData.append("maxGroupSize", parseInt(document.getElementById("tour-groupSize").value));
            ...
            formData.append("imageCover", document.getElementById("tour-cover-image").files[0]);
            _iterator = _createForOfIteratorHelper(document.getElementById("tour-images").files);
            try {
...
if (addDates) {
  addDates.addEventListener("click", function (e) {
    ...
    newDatesField.innerHTML = "<label class=\"form__label\">Tour Dates</label>\n      <input class=\"form__input\" type=\"date\" placeholder=\"Coordinates\" id=\"dates-".concat(dateIndex, "\" required>");
